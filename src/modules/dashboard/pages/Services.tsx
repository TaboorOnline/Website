...
const Services = () => {
  ...
  const getSortIcon = (field: string) => {
    ...
    return sortDirection === 'asc' ? 
      <FiChevronUp className="text-primary-500 w-4 h-4" /> : 
      <FiChevronDown className="text-primary-500 w-4 h-4" />;
  };
      ...
      cell: (service: Service) => {
        ...
        return (
          <div className="flex items-center">
            <div className="flex-shrink-0 w-10 h-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg flex items-center justify-center text-primary-600 dark:text-primary-400 shadow-sm">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-300 dark:border-gray-600 overflow-hidden">
        ...
        <div className="p-4 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-300 dark:border-gray-600 flex flex-wrap items-center justify-between gap-4">
          <div className="relative flex-grow max-w-md">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="p-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md border border-gray-300 dark:border-gray-600 flex items-center focus:outline-none focus:ring-2 focus:ring-primary-500">
        ...
        {!isLoading && sortedServices.length === 0 ? (
          <EmptyState
            ...
            icon={<FiStar className="w-12 h-12 text-primary-400 dark:text-primary-600" />}
