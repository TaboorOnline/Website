...
import React, { ReactElement, ReactNode, JSXElementConstructor, Key, ReactPortal, useEffect, useState } from 'react';
import { useTranslation } from 'react-i18next';
import { motion, AnimatePresence } from 'framer-motion';
import { useLocation } from 'react-router-dom';
import { FiCheck, FiArrowRight, FiArrowUp, FiArrowDown, FiCode, FiCloud, FiLayout, FiLifeBuoy, FiShoppingCart, FiSmartphone, FiTrendingUp } from 'react-icons/fi';
                        ...
                        <div className="text-indigo-600 dark:text-indigo-400 mb-6 transition-transform duration-300 group-hover:scale-110 transform-gpu">
                          <div className="w-14 h-14 bg-indigo-100 dark:bg-indigo-900/40 rounded-xl flex items-center justify-center">
                            {(() => {
                              ...
                              return Icon ? <Icon className="w-8 h-8" /> : <span className="text-2xl">✦</span>;
                            })()}
                          </div>
                        </div>
